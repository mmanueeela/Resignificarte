            ...
            <section id="<?= $id_seccion ?>" class="fila-cuadro <?= $clase_layout ?>" style="<?= $estilo_recompensa ?>">
                ...
                <div class="col-info">
                    ...
                    <div class="reproductor-audio">
                        ...
                        <!-- VOLVER AL PRINCIPIO -->
                        <button class="btn-reiniciar" data-audio-id="audio-<?= $cuadro['id'] ?>">Reiniciar audio</button>

                        <!-- LEER / OCULTAR TEXTO -->
                        <button class="btn-toggle-transcripcion" data-target="transcripcion-<?= $cuadro['id'] ?>">Leer la obra</button>
                    </div>
