// Seleccionar automáticamente el país del usuario en el desplegable
const selectPais = document.getElementById('pais');
const paisGuardado = "<?php echo htmlspecialchars($usuario['pais']); ?>";
if(paisGuardado) selectPais.value = paisGuardado;

// Lógica para el botón Editar / Aceptar / Cancelar
