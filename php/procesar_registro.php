...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 3. Llamamos a nuestra función de registro
            ...
            <tr>
                <td align="center">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0"
                           style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.08);">

                        <tr>
                            <td align="center" style="padding:0;">
                                <img src="https://mzazzar.upv.edu.es/src/logo/logo_email.png"
                                     width="600"
                        ...
                        <tr>
                            <td style="padding: 40px 40px 30px 40px;">
                                ...
                                <p style="margin: 0 0 18px 0; font-size: 16px; line-height: 1.7; color: #555555;">
                                    ...
                                    <strong style="color: #6f42c1;">Resignificarte</strong>.
                                </p>
                        ...
                        <tr>
                            <td align="center"
                                style="background-color: #faf9fc; padding: 22px 30px; border-top: 1px solid #eeeeee;">
