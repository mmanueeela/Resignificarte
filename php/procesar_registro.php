            ...
            <tr>
                <td align="center">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.08);">
                        <!-- CABECERA -->
                        <tr>
                            <td align="center" style="background-color: #200B30; padding: 35px 30px;">
                                <img src="https://mzazzar.upv.edu.es/src/logo/logo_con_inifito.png" alt="Logo de la pagina" style="width: 180px; height: auto; filter: saturate(200%)">
                            </td>
                        </tr>
                        <!-- CONTENIDO -->
                        <tr>
