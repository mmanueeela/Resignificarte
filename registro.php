...
<head>
    ...
    <title>Registro Usuarios | Resignificarte</title>
...
<main>
    <div class="login-container">
        ...
        <!-- Formulario usuarios -->
        <form action="php/procesar_registro.php" method="POST" id="form-registro" novalidate>
            ...
            <div class="placeholders">
                ...
                <div class="fila-doble">
                    <div class="input-group">
                        <img src="src/iconos/cara_mujer.png" alt="Icono usuario" class="input-icon">
                ...
                <!-- Fila 2: País (Ocupa todo el ancho ahora) -->
                <div class="input-group">
                    <img src="src/iconos/mundo.png" alt="Icono país" class="input-icon">
                ...
                <!-- Fila 3: Fecha de Nacimiento con 3 selectores -->
                ...
                <div class="fila-doble">
                    <div class="input-group password-group">
                        ...
                        <img src="src/iconos/ojo-cerrado.png" alt="Ver" class="toggle-password" data-target="password">
                    </div>

                    <div class="input-group password-group">
                        <img src="src/iconos/candado_login.png" alt="Icono candado" class="input-icon">
                        <input type="password" placeholder="Repite contraseña" id="confirm-password" name="confirm_password" required>
                        <img src="src/iconos/ojo-cerrado.png" alt="Ver" class="toggle-password" data-target="confirm-password">
                    </div>
                </div>

            </div> <!-- Cierre de placeholders -->

            <div id="mensaje-error" class="mensaje-error"></div>

            <!-- Zona de aceptar términos -->
            <div class="terminos-condiciones" id="abrir-popup">
                <label class="checkbox-label">
                    <input type="checkbox" id="accept-terms" name="terminos" required>
                    Acepto los <span class="enlace-terminos">Términos y condiciones</span>
                </label>
            </div>
        ...
        <!-- Botón de Google (Ahora es un enlace) -->
    ...
    <div id="popup-overlay" class="popup-overlay">
        <div class="popup-content">
            ...
            <button type="button" id="btn-aceptar-popup" class="btn-login">ACEPTAR</button>
        </div>
    </div>
</main>
