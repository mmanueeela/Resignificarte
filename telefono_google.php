...
<main>
    <div class="forgot-container">
        ...
        <form action="php/procesar_registro_google.php" method="POST" id="form-completar-google" novalidate>
            ...
            <!-- PAÍS (Con todos los options de registro.php) -->
            <?php if ($falta_pais): ?>
                <div class="input-group">
                    <img src="src/iconos/mundo.png" alt="Icono país" class="input-icon">
                    <select id="pais" name="pais" required class="select-transparente">
            ...
            <!-- FECHA DE NACIMIENTO (Idéntica a registro.php) -->
            <?php if ($falta_fecha): ?>
                <div class="fecha-container">
                    ...
                    <div class="fila-triple">
                        <!-- Día -->
                        <div class="input-group">
                            <select id="dia" name="dia" required class="select-transparente">
                        ...
                        <!-- Mes -->
                        <div class="input-group">
                            <select id="mes" name="mes" required class="select-transparente">
                        ...
                        <!-- Año -->
                        <div class="input-group">
                            <select id="ano" name="ano" required class="select-transparente">
